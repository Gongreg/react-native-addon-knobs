...
class ColorType extends React.Component {
  ...
  onChangeColor = (color) => {
    this.props.onChange(fromHsv(color));
  }
        ...
        <TouchableOpacity style={colorStyle} onPress={this.openColorPicker}/>
            ...
            <TouchableWithoutFeedback onPress={this.closeColorPicker}>
              <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
                ...
                <View style={{backgroundColor: 'white', borderWidth: 1, borderColor: 'rgb(247, 244, 244)', width: 250, height: 250, padding: 10}}>
                  <TouchableOpacity onPress={this.closeColorPicker} style={{alignSelf: 'flex-end', padding: 5}}>
