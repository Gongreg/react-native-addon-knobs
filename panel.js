...
import {View, TouchableWithoutFeedback, ScrollView, Text, TouchableOpacity} from 'react-native';
...
export default class Panel extends React.Component {
  ...
  componentDidMount() {
    ...
    this.props.channel.on('selectStory', this.reset);

    this.props.channel.emit('forceReRender');
  }
  ...
  componentWillUnmount() {
    ...
    this.props.channel.removeListener('selectStory', this.reset);
  }
